      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-12">
        <div class="card h-100">
          ...
          <div class="card-header bg-white border-bottom-0 py-4">
            <h4 class="mb-0"> All Clients/Customer </h4>
          </div>
          <!-- table  -->
          @if(count($clients) > 0)
                    ...
                    <div class="dropdown dropstart">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownTeamOne">
                        <a class="dropdown-item"
                          href="{{route('accountant.show.client',Crypt::encrypt($item->id))}}">Show Details</a>
                      </div>
                    </div>
                  </td>
                </tr>
...
<!-- Modal -->
<div class="modal fade" id="deleteAlert" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
