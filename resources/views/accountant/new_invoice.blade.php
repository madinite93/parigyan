                  ...
                  <form method="POST" action="{{ route('accountant.store.invoice') }}">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" id="invoiceSerial" name="invoiceSerial"
                        class="form-control @error('invoiceSerial') is-invalid @enderror" value="{{$serial}}" readonly>
                      @error('invoiceSerial')
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" id="amountToPay" name="amountToPay"
                        class="form-control @error('amountToPay') is-invalid @enderror" placeholder="454" required>
                      @error('amountToPay')
                      <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="date" id="dueDate" name="dueDate"
                        class="form-control @error('dueDate') is-invalid @enderror" required>
                      @error('dueDate')
                      <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
