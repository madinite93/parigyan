            ...
            <div class="dropdown dropstart">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownTeamOne">
                <a class="dropdown-item"
                  href="{{route('accountant.download.invoice',Crypt::encrypt($invoice->id))}}">Download</a>
                @if(!($invoice->isPayEvidenceApproved && $invoice->paymentEvidence))
                @if(!$invoice->isPayEvidenceApproved && $invoice->paymentEvidence )
                <a class="dropdown-item"
                  href="{{route('accountant.confirm.payment.invoice',Crypt::encrypt($invoice->id))}}">
                  Confirm Payment
                </a>
                @else
                <a class="dropdown-item" href="{{route('accountant.edit.invoice',Crypt::encrypt($invoice->id))}}">
                  Edit Details
                </a>
                @endif
                @endif
                <a class="dropdown-item" href="{{route('accountant.delete.invoice',Crypt::encrypt($invoice->id))}}"
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-6 mb-5">
                ...
                <p class="mb-0">
                  <span class="avatar avatar-sm">
                    <img alt="avatar"
                      src="{{$invoice->client->avatar ? asset($invoice->client->avatar) : asset('defaultAvatar.png')}}"
              ...
              <div class="col-6 mb-5">
                ...
                <p class="mb-0"
                  ...
                  <strong>
                    ...
                    'UNPAID' :
                    ($invoice->isPayEvidenceApproved && $invoice->paymentEvidence ? 'Paid & Confirmed' : 'Awaiting
                    Confirmation')
                    }}
                  </strong>
                </p>
              ...
              <div class="col-12">
                <h6 class="text-uppercase fs-5 ls-2">Related Product/Service
                </h6>
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-12 mb-5">
                ...
                <p class="mb-0">{{$invoice->generatedBy->fname ? '(Accountant)-'.$invoice->generatedBy->fname :
                  '(Admin)-'.$invoice->generatedBy->name}}</p>
              </div>
              <div class="col-6 mb-5">
                <!-- text -->
                ...
                <p class="mb-0"> <a class="button"
                    href="{{route('accountant.show.payment.evidence',Crypt::encrypt($invoice->id))}}">
              ...
              <div class="col-6 mb-5">
                ...
                <p class="mb-0" style="color:{{$invoice->paymentDate ? 'green' : 'brown' }}"> <strong>
                    {{$invoice->paymentDate ? $invoice->paymentDate : 'Yet To Pay' }} </strong></p>
              </div>
              <div class="col-12">
                <h6 class="text-uppercase fs-5 ls-2">Payment Confirmed By </h6>
                @if($invoice->isPayEvidenceApproved && $invoice->paymentEvidence)
                <p class="mb-0">{{$invoice->paymentConfirmedBy->fname ? '(Accountant)-'.$invoice->generatedBy->fname :
                  '(Admin)-'.$invoice->generatedBy->name}}</p>
                @else
