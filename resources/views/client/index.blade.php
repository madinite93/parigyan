    ...
    <div class="col-lg-12 col-md-12 col-12">
      ...
      <div>
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div>
            <a href="{{route('client.view.all.project')}}" class="btn btn-white">View Service</a>
          </div>
          <div>
    ...
    <div class="col-md-12 col-12">
      ...
      <div class="card">
              ...
              <tr>
                ...
                <td class="align-middle">
                  <span class="avatar avatar-sm">
                    <img alt="avatar" src="{{asset($item->client->avatar)}}" class="rounded-circle">
                  </span>
                ...
                <td class="align-middle">
                  <div class="dropdown dropstart">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownTeamOne">
                      <a class="dropdown-item" href="{{route('client.show.project', Crypt::encrypt($item->id))}}">Show
                        Details</a>
                    </div>
                  </div>
                </td>
        ...
        <div class="bg-white text-center"
          ...
          <a href="{{route('client.view.all.project')}}">View All Service</a>
        </div>
      </div>
                  ...
                  <div class="dropdown dropstart">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownTeamOne">
                      <a class="dropdown-item"
                        href="{{route('client.download.invoice',Crypt::encrypt($item->id))}}">Download Invoice</a>
                      <a class="dropdown-item" href="{{route('client.show.invoice',Crypt::encrypt($item->id))}}">Show
                        Details</a>
                      @if($item->paymentEvidence == NULL)
                      <a class="dropdown-item" href="{{route('client.edit.invoice',Crypt::encrypt($item->id))}}">Make
                        Payment</a>
                      @endif
                    </div>
                  </div>
