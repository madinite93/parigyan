              ...
              <div class="tab-content p-4" id="pills-tabContent-basic-forms">
                <div class="tab-pane tab-example-design fade show active" id="pills-basic-forms-design" role="tabpanel"
                  ...
                  <table class="table">
                    ...
                    <tr>
                      <td>Related Product/Service</td>
                      <td>{{$invoice->project->title}}</td>
                    </tr>
                  </table> <br><br>
                  <form method="POST" action="{{ route('client.update.invoice', Crypt::encrypt($invoice->id)) }}"
                    ...
                    <div class="mb-3">
                      ...
                      <input type="file" id="paymentEvidence" name="paymentEvidence"
                        class="form-control @error('paymentEvidence') is-invalid @enderror" required>
