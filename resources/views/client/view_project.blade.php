      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-12">
        <div class="card h-100">
          ...
          <div class="card-header bg-white border-bottom-0 py-4">
            <h4 class="mb-0"> All Products/Services </h4>
          </div>
          <!-- table  -->
          <div class="table-responsive" style="padding: 10px;">
                  ...
                  <td class="align-middle">
                    <div class="dropdown dropstart">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownTeamOne">
                        ...
                        <a class="dropdown-item" href="{{route('client.edit.project', Crypt::encrypt($item->id))}}">Edit
                          Feedback</a>
                        @elseif($item->isDelivered)
                        <a class="dropdown-item"
                          href="{{route('client.edit.project', Crypt::encrypt($item->id))}}">Feedback</a>
                        @endif
                      </div>
                    </div>
                  </td>
            ...
            @else
            <p>Products/Services Not Avalable At The Moment</p>
            @endif
