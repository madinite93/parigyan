      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-12">
        <div class="card h-100">
          ...
          <div class="card-header bg-white border-bottom-0 py-4">
            <h4 class="mb-0"> All Invoices for {{Auth::guard('client')->user()->fname}}</h4>
          </div>
          <!-- table  -->
            ...
            <table class="table text-nowrap" id="dataTable" name='dataTable'>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle">{{$item->generatedBy->fname ? '(Acc)-'.Str::limit($item->generatedBy->fname,
                    7,'...' ) : '(Adm)-'.Str::limit($item->generatedBy->name, 7,'...' )}}</td>
