      ...
      <div>
        <div class="border-bottom pb-4 mb-4 ">
          <div class="mb-2 mb-lg-0">
            <h3 class="mb-0 fw-bold">Product/Service Detail</h3>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="bg-white rounded-bottom smooth-shadow-sm ">
        <div class="d-flex align-items-center justify-content-between
          ...
          <div class="d-flex align-items-center">
            <div class="col-12">
              <h6 class="text-uppercase fs-5 ls-2">Category </h6>
              <p class="mb-0">{{$project->category}}</p>
            </div>
          </div>
          <div>
            @if($project->isDelivered && $project->feedback )
            <a href="{{route('client.edit.project', Crypt::encrypt($project->id))}}"
              class="btn btn-outline-primary d-none d-md-block">Edit Feedback</a>
            @elseif($project->isDelivered)
            <a href="{{route('client.edit.project', Crypt::encrypt($project->id))}}"
              class="btn btn-outline-primary d-none d-md-block">Give Feedback</a>
            @endif
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-12 mb-5">
                <!-- text -->
                <h6 class="text-uppercase fs-5 ls-2">Title
                </h6>
              ...
              <div class="col-6 mb-5">
                ...
                <p class="mb-0">{{$project->completeDate ? $project->completeDate->format('D, jS M Y') : 'Not
                  Available'}}</p>
              </div>
              <div class="col-6 mb-5">
                ...
                <div class="mt-2">
                  ...
                  <div class="progress" style="height: 15px;">
                    <div class="progress-bar" role="progressbar" style="width:{{$project->percentageComplete}}%"
                      aria-valuenow="{{$project->percentageComplete}}" aria-valuemin="0" aria-valuemax="100">
                      {{$project->percentageComplete}}%</div>
                  </div>
                </div>
            ...
            <div class="row">
              ...
              <div class="col-6 mb-5">
                ...
                <p class="mb-0"> <a class="button"
                    href="{{route('client.download.project.file', Crypt::encrypt($project->id))}}">Download File</a></p>
                @else
              ...
              <div class="col-6 mb-5">
                ...
                <p class="mb-0">
                  <span class="avatar avatar-sm">
                    <img alt="avatar" src="{{asset($project->client->avatar)}}" class="rounded-circle">
                  </span>
                  {{$project->client->username ? $project->client->username : $project->client->fname }}
                </p>
              </div>
              <div class="col-6 mb-5">
                <h6 class="text-uppercase fs-5 ls-2">Delivery Status</h6>
                <p class="mb-0" style="color:{{$project->isDelivered ? 'green' : 'brown' }}"> <strong>
                    {{$project->isDelivered ? 'Delivered' : 'Not Delivered' }} </strong></p>
              </div>
              <div class="col-6 mb-5">
                <h6 class="text-uppercase fs-5 ls-2">Delivery Date </h6>
                <p class="mb-0">{{$project->deliveryDate ? $project->deliveryDate->format('D, jS M Y') : 'Not
                  Available'}}</p>
              </div>
              <div class="col-12 mb-5">
