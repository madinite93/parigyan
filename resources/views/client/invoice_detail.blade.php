            ...
            <div class="dropdown dropstart">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownTeamOne">
                <a class="dropdown-item"
                  href="{{route('client.download.invoice',Crypt::encrypt($invoice->id))}}">Download Invoice</a>
                @if($invoice->paymentEvidence == NULL)
                <a class="dropdown-item" href="{{route('client.edit.invoice',Crypt::encrypt($invoice->id))}}">Make
                  Payment</a>
                @endif
              </div>
            </div>
              ...
              <div class="col-6 mb-5">
                ...
                <p class="mb-0">
                  <span class="avatar avatar-sm">
                    <img alt="avatar" src="{{asset($invoice->client->avatar)}}" class="rounded-circle">
                  </span>
            ...
            <div class="row">
              ...
              <div class="col-6 mb-5">
                ...
                <p class="mb-0"> <a class="button"
                    href="{{route('client.show.payment.evidence',Crypt::encrypt($invoice->id))}}">
