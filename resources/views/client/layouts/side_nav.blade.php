...
<nav class="navbar-vertical navbar">
    <div class="nav-scroller">
        ...
        <a class="navbar-brand" href="{{route('client.home')}}">
            <img src="{{asset('parigyan.png')}}" width="200" height="70" class="mb-2" alt="">
        </a>
        <!-- Navbar nav -->
        <ul class="navbar-nav flex-column" id="sideNavbar">
            ...
            <!-- Nav item -->
            <li class="nav-item">
                <a class="nav-link has-arrow  collapsed " href="#!" data-bs-toggle="collapse" data-bs-target="#navSales"
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('client.logout') }}" onclick="event.preventDefault();
