            ...
            <div class="row">
              ...
              <div class="col-6 mb-5">
                ...
                <p class="mb-0"> <a class="button"
                    href="{{route('admin.download.project.file', Crypt::encrypt($project->id))}}">Download File</a></p>
                @else
                <p class="mb-0"> Not Available</p>
                @endif
              </div>
              <div class="col-6 mb-5">
                <h6 class="text-uppercase fs-5 ls-2">Customer</h6>
                <p class="mb-0">
              ...
              <div class="col-6 mb-5">
                ...
                <p class="mb-0" style="color:{{$project->isDelivered && $project->deliveryDate ? 'green' : 'brown' }}">
                  <strong> {{$project->isDelivered && $project->deliveryDate ? $project->deliveryDate->format('D, jS M
                    Y') : 'Not Available'}}</strong>
                </p>
              </div>
              <div class="col-12 mb-5">
