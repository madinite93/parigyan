      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-12">
        <div class="card h-100">
          ...
          <div class="table-responsive" style="padding: 10px;">
                ...
                <tr>
                  ...
                  <td class="align-middle">
                    <div class="d-flex align-items-center">
                      <div class="ms-3 lh-1">
                        <p class="mb-0">{{Str::limit($item->category, 20,'...' )}}</p>
                      </div>
                    </div>
                  </td>
                  <td class="align-middle">
                  ...
                  <td class="align-middle">
                    <div class="dropdown dropstart">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownTeamOne">
                        <a class="dropdown-item" href="{{route('admin.show.project', Crypt::encrypt($item->id))}}">Show
                          Details</a>
                        <a class="dropdown-item" href="{{route('admin.edit.project', Crypt::encrypt($item->id))}}">Edit
                          Details</a>
            ...
            @else
            <p>Services Not Avalable At The Moment</p>
            @endif
