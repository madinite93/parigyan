                  ...
                  <td class="align-middle">
                    <div class="dropdown dropstart">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownTeamOne">
                        <a class="dropdown-item" href="{{route('admin.show.invoice',Crypt::encrypt($item->id))}}">Show
                          Details</a>

                        <a class="dropdown-item" href="{{route('admin.edit.invoice',Crypt::encrypt($item->id))}}">
                          Edit Details
                        </a>
                        <a class="dropdown-item" href="{{route('admin.delete.invoice',Crypt::encrypt($item->id))}}"
